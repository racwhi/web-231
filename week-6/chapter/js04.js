...
let acresComplete = true; //  error
let cropsComplete = true;
let monthsComplete = true;
let fuelComplete = true; //  error
...
let monthsFieldset = document.getElementsByTagName("fieldset")[2]; // error
let fuelFieldset = document.getElementsByTagName("fieldset")[3]; // error
...
function verifyAcres() {
  try {
    if (!(acresBox.value > 0)) throw "Enter postive acreage";
    //syntax error
